...
class StorageContainer: ObservableObject {
    ...
    public let projectComparator = ProjectComparator()
    ...
    nonisolated private func terminateProjectStream(_ id: UUID) {
    ...
    nonisolated private func terminateProjectExpressionStream(_ id: UUID) {
    ...
    nonisolated private func terminateExpressionStream(_ id: UUID) {
    ...
    nonisolated private func terminateTranslationStream(_ id: UUID) {
